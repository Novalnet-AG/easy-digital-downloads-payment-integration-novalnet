...
class Novalnet_Global_Config {
    ...
    public function register_novalnet_global_settings( $gateway_settings ) {
        ...
        $url             = ( EDD_VERSION <= '2.5.17' ) ? 'products' : 'novalnet_callback';
        $novalnet_global = array(
            ...
            array(
                ...
                'size'        => 'regular',
                'options'     => array(
                    'novalnet_cc'         => __( 'Credit Card', 'edd-novalnet' ),
                    'novalnet_sepa'       => __( 'Direct Debit SEPA', 'edd-novalnet' ),
                    'novalnet_invoice'    => __( 'Invoice', 'edd-novalnet' ),
                    'novalnet_prepayment' => __( 'Prepayment', 'edd-novalnet' ),
                    'novalnet_paypal'     => __( 'PayPal', 'edd-novalnet' ),
                ),
