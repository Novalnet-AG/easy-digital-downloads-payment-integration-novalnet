			...
			<p>
				<label for="novalnet_prepayment_payment_desc" >
					<span class="edd-description" style="font-size:90%;">
						<?php echo esc_html( __( 'Once you send the order, you will receive an e-mail with the account details to complete the payment.', 'edd-novalnet' ) ); ?>
					</span>
				</label>
			</p>
			<p>
	...
	public function register_novalnet_prepayment_settings( $gateway_settings ) {
		$novalnet_prepayment                     = array(
			...
			array(
				...
				'name'    		=> __( 'Callback order status', 'edd-novalnet' ),
				'type'    		=> 'select',
				'options' 		=> edd_get_payment_statuses(),
				'std'     		=> 'publish',
				'tooltip_title' => __( 'Callback order status', 'edd-novalnet' ),
